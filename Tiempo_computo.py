...
def calculate_all(x_ini_p, delta_p, Ds_p, R_p, r_p, x_ini_n, delta_n, Ds_n, R_n, r_n, t_max, I, T, R_cell, k_p, k_n, S_p, S_n, c_e, num_terms, num_points=3600):
...
num_terms_values = [1,6,11,21,2000]
tiempos_calculo = []

for num_terms in num_terms_values:
    tiempo = calculate_all(x_ini_p, delta_p, Ds_p, R_p, r_p, x_ini_n, delta_n, Ds_n, R_n, r_n, t_max, I, T, R_cell, k_p, k_n, S_p, S_n, c_e, num_terms, num_points=100)  
    tiempos_calculo.append(tiempo)
    
print(tiempos_calculo)
